...
// The original FL ids 800600-800655 were never defined in any Spell.dbc or
// spell_dbc table (verified against the old server DB and both client DBCs) —
// every cast silently no-opped. Mapped onto existing 3.3.5a spells instead;
// CastScaledSpell() rescales effect 0 by difficulty, so only the spell's
// school/visual/mechanic matters here, not its base tuning.
enum Spells
{
    SPELL_UNDERGROUND_SOUL_FLAY = 47106,          // Soul Flay (was FL 800600)
    SPELL_UNDERGROUND_FROSTBOLT = 42842,          // Frostbolt R16 (was FL 800601)
    SPELL_UNDERGROUND_FROST_NOVA = 42917,         // Frost Nova R6 (was FL 800602)
    SPELL_UNDERGROUND_ICE_LANCE = 42914,          // Ice Lance R3 (was FL 800603)
    SPELL_UNDERGROUND_BLIZZARD = 42940,           // Blizzard R9 (was FL 800604)
    SPELL_UNDERGROUND_CLEAVE = 59992,             // Cleave (was FL 800611 alias)
    SPELL_UNDERGROUND_INFECTED_BITE = 43353,      // Infected Bite (was FL 800606)
    SPELL_UNDERGROUND_ENRAGE = 8599,              // Enrage (was FL 800607)
    SPELL_UNDERGROUND_STRIKE = 48640,             // Strike (was FL 800608)
    SPELL_UNDERGROUND_ACID_SPIT = 59270,          // Acid Spit (was FL 800609)
    SPELL_UNDERGROUND_POISON_CLOUD = 59116,       // Poison Cloud (was FL 800610)
    SPELL_UNDERGROUND_TRAMPLE = 67866,            // Trample (was FL 800611 alias)
    SPELL_UNDERGROUND_GORE = 48130,               // Gore (was FL 800612)
    SPELL_UNDERGROUND_BONE_SHIELD = 49222,        // Bone Shield (was FL 800613)
    SPELL_UNDERGROUND_SUNDER_ARMOR = 59350,       // Sunder Armor (was FL 800614)
    SPELL_UNDERGROUND_DEATH_COIL = 47860,         // Death Coil R6 (was FL 800615)
    SPELL_UNDERGROUND_SHADOW_BOLT = 47809,        // Shadow Bolt R13 (was FL 800616)
    SPELL_UNDERGROUND_SHADOWFLAME = 47960,        // Shadowflame R1 (was FL 800617)
    SPELL_UNDERGROUND_FEAR = 6215,                // Fear R3 (was FL 800618)
    SPELL_UNDERGROUND_CURSE_OF_DOOM = 47867,      // Curse of Doom R3 (was FL 800619)
    SPELL_UNDERGROUND_DRAIN_LIFE = 47857,         // Drain Life R9 (was FL 800620)
    SPELL_UNDERGROUND_CURSE_OF_AGONY = 47864,     // Curse of Agony R9 (was FL 800621)
    SPELL_UNDERGROUND_MIND_ROT = 606,             // Mind Rot (was FL 800622)
    SPELL_UNDERGROUND_CURSE_OF_WEAKNESS = 50511,  // Curse of Weakness R9 (was FL 800623)
    SPELL_UNDERGROUND_SHADOW_WORD_PAIN = 48125,   // Shadow Word: Pain R12 (was FL 800624)
    SPELL_UNDERGROUND_SHADOWSTALKER_STAB = 5918,  // Shadowstalker Stab (was FL 800625)
    SPELL_UNDERGROUND_CURSE_OF_IDIOCY = 1010,     // Curse of Idiocy (was FL 800626)
    SPELL_UNDERGROUND_CORRUPTION = 47813,         // Corruption R10 (was FL 800627)
    SPELL_UNDERGROUND_SWARMING_SHADOWS = 71264,   // Swarming Shadows (was FL 800628)
    SPELL_UNDERGROUND_VOID_BOLT = 39329,          // Void Bolt (was FL 800629)
    SPELL_UNDERGROUND_SHADOW_CLAW = 67879,        // Claw (was FL 800630 "Shadow Claw")
    SPELL_UNDERGROUND_VOID_ZONE = 28863,          // Void Zone (was FL 800631)
    SPELL_UNDERGROUND_BITE_WOUND = 37454,         // Bite (was FL 800632 "Bite Wound")
    SPELL_UNDERGROUND_BLOOD_LEECH = 22644,        // Blood Leech (was FL 800633)
    SPELL_UNDERGROUND_EYE_BEAM = 59965,           // Eye Beam (was FL 800634)
    SPELL_UNDERGROUND_SHADOW_SHOCK = 54889,       // Shadow Shock (was FL 800635)
    SPELL_UNDERGROUND_FLESH_REND = 42397,         // Rend Flesh (was FL 800636)
    SPELL_UNDERGROUND_CARNAGE = 59269,            // Carnivorous Bite (was FL 800637 "Carnage")
    SPELL_UNDERGROUND_SOUL_SPIKE = 32315,         // Soul Strike (was FL 800638 "Soul Spike")
    SPELL_UNDERGROUND_BANSHEE_WAIL = 29477,       // Banshee Wail (was FL 800639)
    SPELL_UNDERGROUND_SAVAGE_POUNCE = 64666,      // Savage Pounce (was FL 800640)
    SPELL_UNDERGROUND_FLESH_BITE = 50729,         // Carnivorous Bite (was FL 800641 "Flesh Bite")
    SPELL_UNDERGROUND_ACID_SPLASH = 59363,        // Acid Splash (was FL 800642)
    SPELL_UNDERGROUND_DIGESTIVE_ACID = 26476,     // Digestive Acid (was FL 800643)
    SPELL_UNDERGROUND_WORM_BITE = 52473,          // Bite R10 (was FL 800644 "Worm Bite")
    SPELL_UNDERGROUND_NESTING_VOMIT = 59018,      // Bile Vomit (was FL 800645 "Nesting Vomit")
    SPELL_UNDERGROUND_HOWLING_RAGE = 7484,        // Howling Rage (was FL 800646)
    SPELL_UNDERGROUND_BLOOD_ARMOR = 70654,        // Blood Armor (was FL 800647)
    SPELL_UNDERGROUND_BONE_SPLINTER = 69055,      // Bone Slice (was FL 800648 "Bone Splinter")
    SPELL_UNDERGROUND_SPIRIT_BLAST = 69900,       // Spirit Burst (was FL 800649 "Spirit Blast")
    SPELL_UNDERGROUND_WAIL_OF_TORMENT = 62129,    // Wail of Souls (was FL 800650 "Wail of Torment")
    SPELL_UNDERGROUND_SHALESKIN = 36576,          // Shaleskin (was FL 800651)
    SPELL_UNDERGROUND_ABOMINABLE_SLAM = 67028,    // Slam (was FL 800652 "Abominable Slam")
    SPELL_UNDERGROUND_VILE_CLEAVE = 70191,        // Cleave (was FL 800611 alias, orig. 800653)
    SPELL_UNDERGROUND_NIGHTMARE_BREATH = 59126,   // Shadow Breath (was FL 800654 "Nightmare Breath")
    SPELL_UNDERGROUND_SHADOW_BITE = 54052         // Shadow Bite R4 (was FL 800655)
};
